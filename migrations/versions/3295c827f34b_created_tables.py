...
Revision ID: 3295c827f34b
Revises: ef8472a57d43
Create Date: 2025-04-13 19:46:17.444750
...
revision: str = '3295c827f34b'
down_revision: Union[str, None] = 'ef8472a57d43'
...
def upgrade() -> None:
    ...
    sa.Column('scholarships', sa.Text(), nullable=False),
    sa.Column('admissions', sa.Text(), nullable=True),
